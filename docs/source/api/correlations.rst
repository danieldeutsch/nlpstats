.. _nlpstats.correlations:

nlpstats.correlations
=====================
The :code:`nlpstats.correlations` module provides tools for meta-evaluating metrics.
...
- :ref:`calculating these correlations<correlations>`
- :ref:`estimating confidence intervals for correlations<confidence_intervals>`
- :ref:`statistical testing the difference between correlations<stat_tests>`
